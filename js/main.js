...
/* harmony import */ var _components_map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/map.js */ "./src/js/components/map.js");
...
if (matchMedia('only screen and (min-width: 991px)').matches) {
  ...
  elements.forEach(element => {
    let mask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](element, maskOptions);
  ...
  elements2.forEach(element2 => {
    let mask2 = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](element2, maskOptions2);
...
function loadMap() {
  ...
  coords.forEach(dot => {
    mapDots.insertAdjacentHTML('beforeend', `<div class="dot-wrapper position-absolute">
    ...
    let lastElem = mapDots.querySelectorAll('.dot-wrapper')[mapDots.querySelectorAll('.dot-wrapper').length - 1];
  ...
  let interval = setInterval(el => {
    ...
    if (mapDots.querySelectorAll('.dot-wrapper')[i]) {
      ...
      mapDots.querySelectorAll('.dot-wrapper')[mapDots.querySelectorAll('.dot-wrapper').length - 1].querySelector('.dot-border').style.animation = 'none';
      i = 0;
      let elem = mapDots.querySelectorAll('.dot-wrapper')[i];
      let dotBorder = elem.querySelector('.dot-border');
      let dotText = elem.querySelector('.dot-text');
  ...
  mapDots.querySelectorAll('.dot').forEach(dot => {
    dot.addEventListener('mouseenter', () => {
      dot.parentElement.parentElement.querySelector('.dot-text').innerHTML = dot.parentElement.parentElement.dataset.text;
